 ...
 */
public class ProductCategoryExecutionException extends RuntimeException {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2865065649786224332L;

	public ProductCategoryExecutionException(String msg) {
		super(msg);
	}
}
